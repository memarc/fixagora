...
/**
 * The Class CouponDaysFunction.
 */
public class CouponDaysFunction implements FreeRefFunction {
	...
	public ValueEval evaluate(ValueEval[] args, OperationEvaluationContext ec) {
		...
		try {
			...
			return new NumberEval(AnalysisToolPak.getCoupDays(settlement, maturity, frequency, basis));
