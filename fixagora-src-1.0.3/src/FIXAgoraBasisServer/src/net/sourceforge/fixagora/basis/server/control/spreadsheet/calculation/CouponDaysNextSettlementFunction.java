...
/**
 * The Class CouponDaysNextSettlementFunction.
 */
public class CouponDaysNextSettlementFunction implements FreeRefFunction {
	...
	public ValueEval evaluate(ValueEval[] args, OperationEvaluationContext ec) {
		...
		try {
			...
			return new NumberEval(AnalysisToolPak.getCoupDaysNC(settlement, maturity, frequency, basis));
