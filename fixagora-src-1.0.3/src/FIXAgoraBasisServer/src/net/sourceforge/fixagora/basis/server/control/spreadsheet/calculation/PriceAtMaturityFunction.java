...
/**
 * The Class PriceAtMaturityFunction.
 */
public class PriceAtMaturityFunction implements FreeRefFunction {
	...
	public ValueEval evaluate(ValueEval[] args, OperationEvaluationContext ec) {
		...
		try {
			...
			return new NumberEval(AnalysisToolPak.getPriceMat(settlement, maturity, issue, rate, yield, basis));
