...
/**
 * The Class IntRateFunction.
 */
public class IntRateFunction  implements FreeRefFunction {
    ...
    public ValueEval evaluate( ValueEval[] args, OperationEvaluationContext ec ) {
        ...
        try {
            ...
            double investement  = OperandResolver.coerceValueToDouble( valueEval3 ) ; 
            ...
            return new NumberEval(AnalysisToolPak.getIntRate(settlement, maturity, investement, redemption, basis));
