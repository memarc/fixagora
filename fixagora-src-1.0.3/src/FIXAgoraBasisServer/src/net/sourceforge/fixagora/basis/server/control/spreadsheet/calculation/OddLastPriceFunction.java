...
/**
 * The Class OddLastPriceFunction.
 */
public class OddLastPriceFunction implements FreeRefFunction {
	...
	public ValueEval evaluate(ValueEval[] args, OperationEvaluationContext ec) {
		...
		try {
			...
			double yield = OperandResolver.coerceValueToDouble(valueEval5);
			...
			return new NumberEval(AnalysisToolPak.getOddLPrice(settlement, maturity, lastInterest, rate, yield, redemption, frequency, basis));
