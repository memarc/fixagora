...
/**
 * The Class IssueDateFunction.
 */
public class IssueDateFunction implements FreeRefFunction {
	
	private SecurityDictionary securityDictionary = null;
	
	/**
	 * Instantiates a new issue date function.
	 *
	 * @param securityDictionary the security dictionary
	 */
	public IssueDateFunction(SecurityDictionary securityDictionary) {
	...
	public ValueEval evaluate(ValueEval[] args, OperationEvaluationContext ec) {
		...
		try {
			...
			try {
				...
				if(fSecurity==null)
					return ErrorEval.VALUE_INVALID;
				Date date = fSecurity.getSecurityDetails().getIssueDate();
