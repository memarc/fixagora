...
/**
 * The Class TBillEqFunction.
 */
public class TBillEqFunction implements FreeRefFunction {
	...
	public ValueEval evaluate(ValueEval[] args, OperationEvaluationContext ec) {
		...
		try {
			...
			return new NumberEval(AnalysisToolPak.getTBillEq(settlement, maturity, discount));
