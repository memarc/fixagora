...
/**
 * The Class CleanPriceFunction.
 */
public class CleanPriceFunction  implements FreeRefFunction {
    ...
    public ValueEval evaluate( ValueEval[] args, OperationEvaluationContext ec ) {
        ...
        try {
            ...
            ValueEval valueEval6 = OperandResolver.getSingleValue( args[5], 
                    ec.getRowIndex(), 
                    ec.getColumnIndex() ) ;
            
            ValueEval valueEval7 = null;
            if(args.length==7)
            	valueEval7 = OperandResolver.getSingleValue( args[6], 
                    ec.getRowIndex(), 
                    ec.getColumnIndex() ) ;
            ...
            return new NumberEval(AnalysisToolPak.getPrice(settlement, maturity, rate, yield, redemption, frequency, basis));
