...
/**
 * The Class TBillPriceFunction.
 */
public class TBillPriceFunction implements FreeRefFunction {
	...
	public ValueEval evaluate(ValueEval[] args, OperationEvaluationContext ec) {
		...
		try {
			...
			double discount = OperandResolver.coerceValueToDouble(valueEval3);
			
			return new NumberEval(AnalysisToolPak.getTBillPrice(settlement, maturity, discount));
