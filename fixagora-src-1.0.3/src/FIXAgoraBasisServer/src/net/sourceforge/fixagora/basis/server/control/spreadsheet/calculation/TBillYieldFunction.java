...
/**
 * The Class TBillYieldFunction.
 */
public class TBillYieldFunction implements FreeRefFunction {
	...
	public ValueEval evaluate(ValueEval[] args, OperationEvaluationContext ec) {
		...
		try {
			...
			return new NumberEval(AnalysisToolPak.getTBillYield(settlement, maturity, price));
