...
/**
 * The Class NominalFunction.
 */
public class NominalFunction implements FreeRefFunction {
	...
	public ValueEval evaluate(ValueEval[] args, OperationEvaluationContext ec) {
		...
		try {
			...
			double effectiveRate = OperandResolver.coerceValueToDouble(valueEval1);

			double npery = OperandResolver.coerceValueToDouble(valueEval2);

			return new NumberEval(AnalysisToolPak.getNominal(effectiveRate,npery));
