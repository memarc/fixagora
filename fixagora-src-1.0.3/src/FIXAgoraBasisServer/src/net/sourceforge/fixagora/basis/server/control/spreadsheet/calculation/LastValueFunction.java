 ...
 */
public class LastValueFunction implements FreeRefFunction {
	 ...
	 */
	public LastValueFunction(Map<String, SpreadSheetWorker> nameSpreadSheetWorkerMap) {
	...
	public ValueEval evaluate(ValueEval[] args, OperationEvaluationContext ec) {
		...
		try {
			...
			if (oldValue instanceof Boolean) {
				...
				return new StringEval(oldValue.toString());
			}
			else if (oldValue instanceof Number) {
				return new NumberEval(((Number) oldValue).doubleValue());
			}
