...
/**
 * The Class CouponDateNextFunction.
 */
public class CouponDateNextFunction implements FreeRefFunction {
	...
	public ValueEval evaluate(ValueEval[] args, OperationEvaluationContext ec) {
		...
		try {
			...
			return new NumberEval(AnalysisToolPak.getCoupNcd(settlement, maturity, frequency, basis));
