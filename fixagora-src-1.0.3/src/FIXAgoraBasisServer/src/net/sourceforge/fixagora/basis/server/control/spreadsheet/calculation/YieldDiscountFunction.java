...
/**
 * The Class YieldDiscountFunction.
 */
public class YieldDiscountFunction  implements FreeRefFunction {
    ...
    public ValueEval evaluate( ValueEval[] args, OperationEvaluationContext ec ) {
        ...
        try {
            ...
            double price  = OperandResolver.coerceValueToDouble( valueEval3 ) ; 
            ...
            return new NumberEval(AnalysisToolPak.getYieldDisc(settlement, maturity, price, redemption, basis));
