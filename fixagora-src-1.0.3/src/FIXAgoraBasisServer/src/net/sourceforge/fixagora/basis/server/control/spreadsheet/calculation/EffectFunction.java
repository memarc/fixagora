...
/**
 * The Class EffectFunction.
 */
public class EffectFunction implements FreeRefFunction {
	...
	public ValueEval evaluate(ValueEval[] args, OperationEvaluationContext ec) {
		...
		try {
			...
			double nominalRate = OperandResolver.coerceValueToDouble(valueEval1);

			double npery = OperandResolver.coerceValueToDouble(valueEval2);

			return new NumberEval(AnalysisToolPak.getEffect(nominalRate,npery));
