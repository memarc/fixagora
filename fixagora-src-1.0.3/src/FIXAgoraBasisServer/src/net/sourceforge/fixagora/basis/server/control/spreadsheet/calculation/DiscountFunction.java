...
/**
 * The Class DiscountFunction.
 */
public class DiscountFunction  implements FreeRefFunction {
    ...
    public ValueEval evaluate( ValueEval[] args, OperationEvaluationContext ec ) {
        ...
        try {
            ...
            return new NumberEval(AnalysisToolPak.getDisc(settlement, maturity, price, redemption, basis));
