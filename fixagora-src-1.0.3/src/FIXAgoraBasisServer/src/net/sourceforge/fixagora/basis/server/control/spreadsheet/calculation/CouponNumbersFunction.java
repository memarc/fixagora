...
/**
 * The Class CouponNumbersFunction.
 */
public class CouponNumbersFunction implements FreeRefFunction {
	...
	public ValueEval evaluate(ValueEval[] args, OperationEvaluationContext ec) {
		...
		try {
			...
			return new NumberEval(AnalysisToolPak.getCoupNum(settlement, maturity, frequency, basis));			
