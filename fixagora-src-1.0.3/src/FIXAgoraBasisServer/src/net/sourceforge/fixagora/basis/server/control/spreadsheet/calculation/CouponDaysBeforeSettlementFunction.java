...
/**
 * The Class CouponDaysBeforeSettlementFunction.
 */
public class CouponDaysBeforeSettlementFunction implements FreeRefFunction {
	...
	public ValueEval evaluate(ValueEval[] args, OperationEvaluationContext ec) {
		...
		try {
			...
			return new NumberEval(AnalysisToolPak.getCouponDayBS(settlement, maturity, frequency, basis));
