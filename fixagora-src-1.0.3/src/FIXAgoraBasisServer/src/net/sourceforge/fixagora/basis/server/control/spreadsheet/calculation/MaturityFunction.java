...
/**
 * The Class MaturityFunction.
 */
public class MaturityFunction implements FreeRefFunction {

	private SecurityDictionary securityDictionary = null;
	
	
	/**
	 * Instantiates a new maturity function.
	 *
	 * @param securityDictionary the security dictionary
	 */
	public MaturityFunction(SecurityDictionary securityDictionary) {
	...
	public ValueEval evaluate(ValueEval[] args, OperationEvaluationContext ec) {
		...
		try {
			...
			if(fSecurity==null)
				return ErrorEval.VALUE_INVALID;
			Date date = fSecurity.getMaturity();
			if(date==null)
				return ErrorEval.VALUE_INVALID;
