...
/**
 * The Class OpenExcelTradeCaptureRequest.
 */
public class OpenExcelTradeCaptureRequest extends AbstractExcelRequest {
	...
	/**
	 * Instantiates a new open excel trade capture request.
	 *
	 * @param tradeCapture the trade capture
	 * @param requestID the request id
	 */
	public OpenExcelTradeCaptureRequest(long tradeCapture,long requestID) {
	...
	public void handleAbstractExcelRequest(ExcelRequests excelRequests, Channel channel) {
		...
		excelRequests.onOpenExcelTradeCaptureRequest(this, channel);
