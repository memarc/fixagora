...
/**
 * The Class AbstractExcelRequest.
 */
public abstract class AbstractExcelRequest extends AbstractRequest{

	private static final long serialVersionUID = 1L;

	/**
	 * Instantiates a new abstract excel request.
	 *
	 * @param requestID the request id
	 */
	public AbstractExcelRequest(long requestID) {
	...
	public void handleAbstractRequest(AbstractRequests abstractRequests, Channel channel) {
		...
		if(abstractRequests instanceof ExcelRequests)
		{
			ExcelRequests excelRequests = (ExcelRequests)abstractRequests;
			handleAbstractExcelRequest(excelRequests, channel);
		}
	 ...
	 */
	public abstract void handleAbstractExcelRequest(ExcelRequests excelRequests, Channel channel);	
