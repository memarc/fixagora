...
/**
 * The Class CloseSAPTradeCaptureResponse.
 */
public class CloseSAPTradeCaptureResponse extends AbstractSAPResponse {

	private static final long serialVersionUID = 1L;
	
	/**
	 * Instantiates a new close sap trade capture response.
	 *
	 * @param closeTradeCaptureRequest the close trade capture request
	 */
	public CloseSAPTradeCaptureResponse(CloseSAPTradeCaptureRequest closeTradeCaptureRequest) {

		super(closeTradeCaptureRequest);
	}
