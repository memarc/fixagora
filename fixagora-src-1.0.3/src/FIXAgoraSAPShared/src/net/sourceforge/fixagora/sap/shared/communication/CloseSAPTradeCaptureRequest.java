...
/**
 * The Class CloseSAPTradeCaptureRequest.
 */
public class CloseSAPTradeCaptureRequest extends AbstractSAPRequest {
	...
	/**
	 * Instantiates a new close sap trade capture request.
	 *
	 * @param tradeCapture the trade capture
	 * @param requestID the request id
	 */
	public CloseSAPTradeCaptureRequest(long tradeCapture, long requestID) {
	...
	public void handleAbstractSAPRequest(SAPRequests excelRequests, Channel channel) {
		...
		excelRequests.onCloseSAPTradeCaptureRequest(this, channel);
