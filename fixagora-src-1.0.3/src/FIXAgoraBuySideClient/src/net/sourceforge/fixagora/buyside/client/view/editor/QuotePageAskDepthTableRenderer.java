...
/**
 * The Class QuotePageAskDepthTableRenderer.
 */
public class QuotePageAskDepthTableRenderer implements TableCellRenderer {
	 ...
	 */
	public QuotePageAskDepthTableRenderer(BuySideQuotePage buySideQuotePage) {
		...
		if (((BuySideQuotePageEditorDepthTableModel) table.getModel()).getMouseOverRow() == row)
			...
			switch (column) {
				...
				case 1:
					...
					{
						try {
							component.setText(dollarFraction.getDollarPrice(buySideMDInputEntry.getMdEntryAskPxValue(),1,true));
							...
							component.setText(buySideQuotePageEntry.getPriceDecimalFormat().format(buySideMDInputEntry.getMdEntryAskPxValue()));
						}
					}
					else
						component.setText(buySideQuotePageEntry.getPriceDecimalFormat().format(buySideMDInputEntry.getMdEntryAskPxValue()));
					...
					if (buySideQuotePageEntry != null && buySideQuotePageEntry.getAskPriceUp() != null) {
						...
						if (buySideQuotePageEntry.getAskPriceUp())
							component.setForeground(getHighlightColor(foreGroundGreen, buySideQuotePageEntry.getAskPriceUpdate()));

						else
							component.setForeground(getHighlightColor(foreGroundRed, buySideQuotePageEntry.getAskPriceUpdate()));
					}
				...
				case 2:
					if (buySideMDInputEntry == null || buySideMDInputEntry.getMdEntryAskYieldValue() == null)
						...
						component.setText(buySideQuotePageEntry.getYieldDecimalFormat().format(buySideMDInputEntry.getMdEntryAskYieldValue()));
				...
				case 3:
					if (buySideMDInputEntry == null || buySideMDInputEntry.getMdEntryAskSizeValue() == null)
						...
						component.setText(buySideQuotePageEntry.getSizeDecimalFormat().format(buySideMDInputEntry.getMdEntryAskSizeValue()));
