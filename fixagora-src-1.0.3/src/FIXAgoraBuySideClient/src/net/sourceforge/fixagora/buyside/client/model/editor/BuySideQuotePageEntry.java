...
public class BuySideQuotePageEntry {
	...
	private AbstractBuySideMDInputEntry buySideMDInputEntry = null;
	 ...
	 *
	 * @return the buy side md input entry
	 */
	public AbstractBuySideMDInputEntry getBuySideMDInputEntry() {

		return buySideMDInputEntry;
	}

	/**
	 * Sets the buy side md input entry.
	 *
	 * @param buySideMDInputEntry the new buy side md input entry
	 */
	public void setBuySideMDInputEntry(AbstractBuySideMDInputEntry buySideMDInputEntry) {

		if (this.buySideMDInputEntry != null) {
			if (this.buySideMDInputEntry.getMdEntryBidPxValue() == null || buySideMDInputEntry.getMdEntryBidPxValue() == null)
				bidPriceUp = null;
			else if (this.buySideMDInputEntry.getMdEntryBidPxValue() > buySideMDInputEntry.getMdEntryBidPxValue()) {
				bidPriceUp = false;
			...
			if (this.buySideMDInputEntry.getMdEntryAskPxValue() == null || buySideMDInputEntry.getMdEntryAskPxValue() == null)
				askPriceUp = null;
			else if (this.buySideMDInputEntry.getMdEntryAskPxValue() > buySideMDInputEntry.getMdEntryAskPxValue()) {
				askPriceUp = false;
		...
		this.buySideMDInputEntry = buySideMDInputEntry;
	}
	 ...
	 *
	 * @param priceDecimalFormat the new price decimal format
	 */
	public void setPriceDecimalFormat(DecimalFormat priceDecimalFormat) {
	
		this.priceDecimalFormat = priceDecimalFormat;
	}
