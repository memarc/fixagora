...
/**
 * The Class ExcelImportHeaderRenderer.
 */
public class ExcelImportHeaderRenderer extends JLabel implements TableCellRenderer {
	...
	/**
	 * Instantiates a new excel import header renderer.
	 */
	public ExcelImportHeaderRenderer() {
