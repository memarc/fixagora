...
/**
 * The Class MonthSpinner.
 */
public class MonthSpinner extends AbstractDateSpinner {

	private static final long serialVersionUID = 1L;

	/**
	 * Instantiates a new month spinner.
	 *
	 * @param cellEditor the cell editor
	 * @param backgroundColor the background color
	 */
	public MonthSpinner(final CellEditor cellEditor, Color backgroundColor) {
