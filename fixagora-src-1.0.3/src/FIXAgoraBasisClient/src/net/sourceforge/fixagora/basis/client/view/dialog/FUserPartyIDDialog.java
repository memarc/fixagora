...
/**
 * The Class FUserPartyIDDialog.
 */
public class FUserPartyIDDialog extends JDialog {

	private static final long serialVersionUID = 1L;
	private final JPanel contentPanel = new JPanel();
	private boolean cancelled = true;
	private JButton okButton;
	private FUserPartyID fUserPartyID = null;
	 ...
	 */
	public FUserPartyIDDialog(FUserPartyID fUserPartyID, List<AbstractBusinessObject> businessComponents) {

		this.fUserPartyID = fUserPartyID;
		setBounds(100, 100, 517, 237);
		setBackground(new Color(204, 216, 255));
		setIconImage(new ImageIcon(FUserPartyIDDialog.class.getResource("/net/sourceforge/fixagora/basis/client/view/images/16x16/a-logo.png")).getImage());
		setModal(true);
		...
		if(fUserPartyID!=null&&fUserPartyID.getAbstractBusinessComponent()!=null)
			businessComponentComboBox.setSelectedItem(new ComboBoxEntry(fUserPartyID.getAbstractBusinessComponent(), null));
		else
		...
		if(fUserPartyID!=null)
			partyIDTextField.setText(fUserPartyID.getPartyID());
		...
		if(fUserPartyID!=null)
			partyIDSourceComboBox.setSelectedItem(new ComboBoxEntry(fUserPartyID.getPartyIDSource(), null));
		else
		...
		partyRoleComboBoxEntries.add(new ComboBoxEntry(36, "Entering fUser"));
		partyRoleComboBoxEntries.add(new ComboBoxEntry(37, "Contra fUser"));
		...
		if(fUserPartyID!=null)
			partyRoleComboBox.setSelectedItem(new ComboBoxEntry(fUserPartyID.getPartyRole(), null));
		else
		...
		if (this.fUserPartyID == null) {
			this.fUserPartyID = new FUserPartyID();
		...
		okButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				cancelled = false;				
				FUserPartyIDDialog.this.fUserPartyID.setAbstractBusinessComponent((AbstractBusinessComponent) ((ComboBoxEntry) businessComponentComboBox.getSelectedItem()).getEntry());
				FUserPartyIDDialog.this.fUserPartyID.setPartyID(partyIDTextField.getText());
				FUserPartyIDDialog.this.fUserPartyID.setPartyIDSource((String) ((ComboBoxEntry) partyIDSourceComboBox.getSelectedItem()).getEntry());
				if (businessComponentComboBox.getSelectedIndex() == 0)
					FUserPartyIDDialog.this.fUserPartyID.setPartyRole(null);
				else
					FUserPartyIDDialog.this.fUserPartyID.setPartyRole((Integer) ((ComboBoxEntry) partyRoleComboBox.getSelectedItem()).getEntry());
				setVisible(false);
			}
		});
	...
	private void checkConsistency() {
		...
		if (fUserPartyID.getAbstractBusinessComponent() != null && !fUserPartyID.getAbstractBusinessComponent().equals(((ComboBoxEntry) businessComponentComboBox.getSelectedItem()).getEntry()))
			dirty = true;
		...
		if (fUserPartyID.getPartyIDSource() != null && !fUserPartyID.getPartyIDSource().equals(((ComboBoxEntry) partyIDSourceComboBox.getSelectedItem()).getEntry()))
			dirty = true;
		...
		if (fUserPartyID.getPartyRole() != null && !fUserPartyID.getPartyRole().equals(((ComboBoxEntry) partyRoleComboBox.getSelectedItem()).getEntry()))
			dirty = true;
		...
		if(dirtyFieldCheck(fUserPartyID.getPartyID(), partyIDTextField))
			dirty=true;
	 ...
	 */
	public FUserPartyID getFUserPartyID() {
