...
/**
 * The Class TraderPartyIDDialog.
 */
public class TraderPartyIDDialog extends JDialog {

	private static final long serialVersionUID = 1L;
	private final JPanel contentPanel = new JPanel();
	private boolean cancelled = true;
	private JButton okButton;
	private TraderPartyID traderPartyID = null;
	 ...
	 */
	public TraderPartyIDDialog(TraderPartyID traderPartyID, List<AbstractBusinessObject> businessComponents) {

		this.traderPartyID = traderPartyID;
		setBounds(100, 100, 517, 237);
		setBackground(new Color(204, 216, 255));
		setIconImage(new ImageIcon(TraderPartyIDDialog.class.getResource("/net/sourceforge/fixagora/basis/client/view/images/16x16/a-logo.png")).getImage());
		setModal(true);
		...
		if(traderPartyID!=null&&traderPartyID.getAbstractBusinessComponent()!=null)
			businessComponentComboBox.setSelectedItem(new ComboBoxEntry(traderPartyID.getAbstractBusinessComponent(), null));
		else
		...
		if(traderPartyID!=null)
			partyIDTextField.setText(traderPartyID.getPartyID());
		...
		if(traderPartyID!=null)
			partyIDSourceComboBox.setSelectedItem(new ComboBoxEntry(traderPartyID.getPartyIDSource(), null));
		else
		...
		if(traderPartyID!=null)
			partyRoleComboBox.setSelectedItem(new ComboBoxEntry(traderPartyID.getPartyRole(), null));
		else
		...
		if (this.traderPartyID == null) {
			this.traderPartyID = new TraderPartyID();
		...
		okButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				cancelled = false;				
				TraderPartyIDDialog.this.traderPartyID.setAbstractBusinessComponent((AbstractBusinessComponent) ((ComboBoxEntry) businessComponentComboBox.getSelectedItem()).getEntry());
				TraderPartyIDDialog.this.traderPartyID.setPartyID(partyIDTextField.getText());
				TraderPartyIDDialog.this.traderPartyID.setPartyIDSource((String) ((ComboBoxEntry) partyIDSourceComboBox.getSelectedItem()).getEntry());
				if (businessComponentComboBox.getSelectedIndex() == 0)
					TraderPartyIDDialog.this.traderPartyID.setPartyRole(null);
				else
					TraderPartyIDDialog.this.traderPartyID.setPartyRole((Integer) ((ComboBoxEntry) partyRoleComboBox.getSelectedItem()).getEntry());
				setVisible(false);
			}
		});
	...
	private void checkConsistency() {
		...
		if (traderPartyID.getAbstractBusinessComponent() != null && !traderPartyID.getAbstractBusinessComponent().equals(((ComboBoxEntry) businessComponentComboBox.getSelectedItem()).getEntry()))
			dirty = true;
		...
		if (traderPartyID.getPartyIDSource() != null && !traderPartyID.getPartyIDSource().equals(((ComboBoxEntry) partyIDSourceComboBox.getSelectedItem()).getEntry()))
			dirty = true;
		...
		if (traderPartyID.getPartyRole() != null && !traderPartyID.getPartyRole().equals(((ComboBoxEntry) partyRoleComboBox.getSelectedItem()).getEntry()))
			dirty = true;
		...
		if(dirtyFieldCheck(traderPartyID.getPartyID(), partyIDTextField))
			dirty=true;
	 ...
	 */
	public TraderPartyID getTraderPartyID() {
