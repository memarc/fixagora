...
/**
 * The Class FSecurityGroupEditor.
 */
public class FSecurityGroupEditor extends AbstractBusinessObjectEditor {
	...
	private FSecurityGroupMasterData userEditorMasterData = null;
	...
	/**
	 * Instantiates a new f security group editor.
	 *
	 * @param securityGroup the security group
	 * @param mainPanel the main panel
	 * @param basisClientConnector the basis client connector
	 */
	public FSecurityGroupEditor(FSecurityGroup securityGroup, MainPanel mainPanel, BasisClientConnector basisClientConnector) {

		super(securityGroup, mainPanel, basisClientConnector);
	...
	public void initContent() {
		...
		userEditorMasterData = new FSecurityGroupMasterData(this);
	...
	public void updateContent(AbstractBusinessObject abstractBusinessObject) {
		...
		if (abstractBusinessObject instanceof FSecurityGroup) {
			super.updateContent(abstractBusinessObject);

			this.securityGroup = (FSecurityGroup) abstractBusinessObject;
