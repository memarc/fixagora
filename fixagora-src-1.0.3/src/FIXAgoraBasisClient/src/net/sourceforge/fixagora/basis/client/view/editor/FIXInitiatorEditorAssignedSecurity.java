...
import net.sourceforge.fixagora.basis.client.model.dnd.AssignedSecurityDropTarget;
...
import net.sourceforge.fixagora.basis.client.view.dialog.AssignedSecurityDialog;
import net.sourceforge.fixagora.basis.shared.model.persistence.AssignedInitiatorSecurity;

/**
 * The Class FIXInitiatorEditorAssignedSecurity.
 */
public class FIXInitiatorEditorAssignedSecurity extends JPanel {

	private JButton addButton;
	private JTable table;
	private FIXInitiatorEditor fixInitiatorEditor;
	private AssignedSecurityTableModel assignedSecurityTableModel;
	private JButton removeButton;
	private JScrollPane scrollPane;
	private JButton editButton;
	private DefaultEditorTableRenderer defaultEditorTableRenderer;

	/**
	 * Instantiates a new fIX initiator editor assigned security.
	 *
	 * @param fixInitiatorEditor the fix initiator editor
	 */
	public FIXInitiatorEditorAssignedSecurity(final FIXInitiatorEditor fixInitiatorEditor) {
		...
		assignedSecurityTableModel = new AssignedSecurityTableModel(fixInitiatorEditor);
		...
		defaultEditorTableRenderer = new DefaultEditorTableRenderer(fixInitiatorEditor);

		table.setDefaultRenderer(Object.class, defaultEditorTableRenderer);
		...
		new AssignedSecurityDropTarget(table, fixInitiatorEditor, this, assignedSecurityTableModel);
		...
		removeButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (table.getSelectionModel().getMinSelectionIndex() != -1
						&& fixInitiatorEditor.getBasisClientConnector().getFUser().canWrite(fixInitiatorEditor.getAbstractBusinessObject())) {
					
					List<AssignedInitiatorSecurity> assignedInitiatorSecurities = new ArrayList<AssignedInitiatorSecurity>();
					for(int index: table.getSelectedRows())
						assignedInitiatorSecurities.add(assignedSecurityTableModel.get(index));
					for(AssignedInitiatorSecurity assignedInitiatorSecurity: assignedInitiatorSecurities)
						assignedSecurityTableModel.remove(assignedInitiatorSecurity);
					checkConsistency();
				}
			}
		});
		...
		addButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				AssignedSecurityDialog assignedSecurityDialog = new AssignedSecurityDialog(null,fixInitiatorEditor.getMainPanel().getSecurityTreeDialog(),fixInitiatorEditor.getMainPanel().getCounterpartyTreeDialog());
				assignedSecurityDialog.setVisible(true);
				if (!assignedSecurityDialog.isCancelled()) {
					AssignedInitiatorSecurity assignedInitiatorSecurity = assignedSecurityDialog.getAssignedInitiatorSecurity();
		...
		editButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (table.getSelectionModel().getMinSelectionIndex() != -1
					...
					AssignedSecurityDialog assignedSecurityDialog = new AssignedSecurityDialog(assignedSecurityTableModel.get(table.getSelectionModel().getMinSelectionIndex()),fixInitiatorEditor.getMainPanel().getSecurityTreeDialog(),fixInitiatorEditor.getMainPanel().getCounterpartyTreeDialog());
					assignedSecurityDialog.setVisible(true);
					if (!assignedSecurityDialog.isCancelled()) {
		...
		table.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
			...
			public void valueChanged(ListSelectionEvent e) {
				...
				if (table.getSelectionModel().getMinSelectionIndex() != -1
						&& fixInitiatorEditor.getBasisClientConnector().getFUser().canWrite(fixInitiatorEditor.getAbstractBusinessObject())&&fixInitiatorEditor.getFixInitiator().getStartLevel()==0) {
	...
	public void updateContent() {
		...
		assignedSecurityTableModel.updateAssignedInitiatorSecurities(fixInitiatorEditor.getFixInitiator().getAssignedInitiatorSecurities());

		if (fixInitiatorEditor.getBasisClientConnector().getFUser().canWrite(fixInitiatorEditor.getAbstractBusinessObject())&&fixInitiatorEditor.getFixInitiator().getStartLevel()==0) {

			scrollPane.getViewport().setBackground(new Color(255, 243, 204));
			defaultEditorTableRenderer.setEnabled(true);
			table.setBackground(new Color(255, 243, 204));
			...
			defaultEditorTableRenderer.setEnabled(false);
