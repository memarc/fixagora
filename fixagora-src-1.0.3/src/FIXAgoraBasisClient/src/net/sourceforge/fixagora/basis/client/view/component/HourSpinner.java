...
/**
 * The Class HourSpinner.
 */
public class HourSpinner extends AbstractDateSpinner {

	private static final long serialVersionUID = 1L;

	/**
	 * Instantiates a new hour spinner.
	 *
	 * @param cellEditor the cell editor
	 * @param backgroundColor the background color
	 */
	public HourSpinner(final CellEditor cellEditor, Color backgroundColor) {
