...
/**
 * The Class AcceptorTreeDialog.
 */
public class AcceptorTreeDialog extends JDialog {

	private static final long serialVersionUID = 1L;
	private final JPanel contentPanel = new JPanel();
	private boolean cancelled = true;
	private JButton okButton;
	private AbstractAcceptor abstractBusinessComponent = null;
	...
	/**
	 * Instantiates a new acceptor tree dialog.
	 *
	 * @param basisClientConnector the basis client connector
	 */
	public AcceptorTreeDialog(BasisClientConnector basisClientConnector) {

		this.basisClientConnector = basisClientConnector;

		setBounds(100, 100, 487, 494);
		setBackground(new Color(204, 216, 255));
		setIconImage(new ImageIcon(AcceptorTreeDialog.class.getResource("/net/sourceforge/fixagora/basis/client/view/images/16x16/a-logo.png")).getImage());
		setModal(true);
			...
			public void mouseClicked(final MouseEvent e) {
				...
				if (e.getClickCount() == 2) {
					...
					if (path != null) {
						...
						if (node.getUserObject() instanceof AbstractAcceptor) {

							abstractBusinessComponent = (AbstractAcceptor) node.getUserObject();
							setVisible(false);
						}
					}
				}
			...
			public void valueChanged(final TreeSelectionEvent treeSelectionEvent) {
				...
				if (tree.getSelectionPaths() != null)
					for (TreePath treePath : tree.getSelectionPaths()) {
						...
						if (object instanceof AbstractAcceptor) {
							abstractBusinessComponent = (AbstractAcceptor) object;
						}
						else {
	...
	/**
	 * Gets the abstract acceptor list.
	 *
	 * @return the abstract acceptor list
	 */
	public List<String> getAbstractAcceptorList() {
	...
	/**
	 * Gets the abstract acceptor for name.
	 *
	 * @param name the name
	 * @return the abstract acceptor for name
	 */
	public AbstractAcceptor getAbstractAcceptorForName(String name) {
		...
		for (BusinessObjectTreeNode defaultMutableTreeNode : defaultMutableTreeNodeMap.values())
			...
			if (defaultMutableTreeNode.getUserObject() instanceof AbstractAcceptor) {
				...
				AbstractAcceptor abstractBusinessComponent = (AbstractAcceptor) defaultMutableTreeNode.getUserObject();
	...
	/**
	 * Gets the abstract acceptor.
	 *
	 * @return the abstract acceptor
	 */
	public AbstractAcceptor getAbstractAcceptor() {
	...
	public void onPersistResponse(PersistResponse persistResponse) {
		...
		if (abstractBusinessObject instanceof AbstractAcceptor) {
	...
	/**
	 * Gets the abstract acceptor for id.
	 *
	 * @param interfaceValue the interface value
	 * @return the abstract acceptor for id
	 */
	public AbstractAcceptor getAbstractAcceptorForId(long interfaceValue) {
