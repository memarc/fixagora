...
/**
 * The Class CloseSellSideBookResponse.
 */
public class CloseSellSideBookResponse extends AbstractSellSideResponse {

	private static final long serialVersionUID = 1L;
	
	/**
	 * Instantiates a new close sell side book response.
	 *
	 * @param closeSellSideBookRequest the close sell side book request
	 */
	public CloseSellSideBookResponse(CloseSellSideBookRequest closeSellSideBookRequest) {

		super(closeSellSideBookRequest);
	}
