 ...
 */
public abstract class AbstractSellSideResponse extends AbstractResponse {
	...
	public void handleAbstractResponse(AbstractResponses abstractResponses) {
		...
		if(abstractResponses instanceof SellSideResponses)
		{
			SellSideResponses sellSideResponses = (SellSideResponses)abstractResponses;
			handleSellSideResponse(sellSideResponses);
		}
