 ...
 * 
 **/
package net.sourceforge.fixagora.sellside.shared.control;
...
public class MDInputEntryConverter {
	 ...
	 * @return the bytes
	 */
	public static byte[] getBytes(List<SellSideMDInputEntry> abstractBuySideMDInpuEntries)
	{
		try {
	 ...
	 */
	public static List<SellSideMDInputEntry> getSellSideMDInputEntries(byte[] bytes)
	{
		try {
			...
			List<SellSideMDInputEntry> abstractBuySideMDInpuEntries = (List<SellSideMDInputEntry>) objectInputStream.readObject();

			return abstractBuySideMDInpuEntries;
		}
		catch (Exception e) {
			return new ArrayList<SellSideMDInputEntry>();
		}
