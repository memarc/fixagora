...
/**
 * The Class OpenQuoteMonitorResponse.
 */
public class OpenQuoteMonitorResponse extends AbstractSellSideResponse {

	private static final long serialVersionUID = 1L;
		
	/**
	 * Instantiates a new open quote monitor response.
	 *
	 * @param openSpreadSheetRequest the open spread sheet request
	 */
	public OpenQuoteMonitorResponse(OpenQuoteMonitorRequest openSpreadSheetRequest) {
