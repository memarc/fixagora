...
/**
 * The Class CloseSellSideBookRequest.
 */
public class CloseSellSideBookRequest extends AbstractSellSideRequest {
	...
	/**
	 * Instantiates a new close sell side book request.
	 *
	 * @param sellSideBook the sell side book
	 * @param requestID the request id
	 */
	public CloseSellSideBookRequest(long sellSideBook, long requestID) {
	...
	public void handleSellSideRequest(SellSideRequests sellSideRequests, Channel channel) {
		...
		sellSideRequests.onCloseSellSideBookRequest(this, channel);
