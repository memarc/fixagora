...
/**
 * The Class CloseQuoteMonitorRequest.
 */
public class CloseQuoteMonitorRequest extends AbstractSellSideRequest {
	...
	/**
	 * Instantiates a new close quote monitor request.
	 *
	 * @param sellSideQuotePage the sell side quote page
	 * @param requestID the request id
	 */
	public CloseQuoteMonitorRequest(long sellSideQuotePage, long requestID) {
	...
	public void handleSellSideRequest(SellSideRequests sellSideRequests, Channel channel) {
		...
		sellSideRequests.onCloseQuoteMonitorRequest(this, channel);
