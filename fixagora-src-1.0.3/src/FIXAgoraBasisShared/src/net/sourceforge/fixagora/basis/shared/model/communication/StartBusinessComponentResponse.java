...
/**
 * The Class StartBusinessComponentResponse.
 */
public class StartBusinessComponentResponse extends AbstractBasisResponse {

	private static final long serialVersionUID = 1L;
		
	/**
	 * Instantiates a new start business component response.
	 *
	 * @param startBusinessComponentRequest the start business component request
	 */
	public StartBusinessComponentResponse(StartBusinessComponentRequest startBusinessComponentRequest) {

		super(startBusinessComponentRequest);
	}
