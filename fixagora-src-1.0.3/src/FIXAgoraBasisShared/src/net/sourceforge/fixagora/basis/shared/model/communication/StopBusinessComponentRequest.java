...
/**
 * The Class StopBusinessComponentRequest.
 */
public class StopBusinessComponentRequest extends AbstractBasisRequest {
	...
	/**
	 * Instantiates a new stop business component request.
	 *
	 * @param requestID the request id
	 * @param businessComponents the business components
	 */
	public StopBusinessComponentRequest(long requestID, List<Long> businessComponents) {
	...
	public void handleAbstractFBasisRequest(BasisRequests basisRequests, Channel channel) {
		...
		basisRequests.onStopBusinessComponentRequest(this, channel);
