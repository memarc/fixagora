...
/**
 * The Class ModifySpreadSheetCellFormatResponse.
 */
public class ModifySpreadSheetCellFormatResponse extends AbstractBasisResponse {

	private static final long serialVersionUID = 1L;
		
	/**
	 * Instantiates a new modify spread sheet cell format response.
	 *
	 * @param modifySpreadSheetCellFormatRequest the modify spread sheet cell format request
	 */
	public ModifySpreadSheetCellFormatResponse(ModifySpreadSheetCellFormatRequest modifySpreadSheetCellFormatRequest) {

		super(modifySpreadSheetCellFormatRequest);
	}
