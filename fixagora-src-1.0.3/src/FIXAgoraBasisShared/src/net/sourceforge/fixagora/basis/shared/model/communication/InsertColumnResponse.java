...
/**
 * The Class InsertColumnResponse.
 */
public class InsertColumnResponse extends AbstractBasisResponse {

	private static final long serialVersionUID = 1L;
		
	/**
	 * Instantiates a new insert column response.
	 *
	 * @param insertColumnRequest the insert column request
	 */
	public InsertColumnResponse(InsertColumnRequest insertColumnRequest) {

		super(insertColumnRequest);
	}
