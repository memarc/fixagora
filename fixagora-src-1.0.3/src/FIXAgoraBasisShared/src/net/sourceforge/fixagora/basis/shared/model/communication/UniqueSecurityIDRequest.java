...
/**
 * The Class UniqueSecurityIDRequest.
 */
public class UniqueSecurityIDRequest extends AbstractBasisRequest {
	...
	/**
	 * Instantiates a new unique security id request.
	 *
	 * @param name the name
	 * @param id the id
	 * @param requestID the request id
	 */
	public UniqueSecurityIDRequest(String name, long id, long requestID) {
	...
	public void handleAbstractFBasisRequest(BasisRequests basisRequests, Channel channel) {
		...
		basisRequests.onUniqueSecurityIDRequest(this, channel);	
	}
