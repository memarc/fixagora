...
/**
 * The Class ModifyColumnWidthResponse.
 */
public class ModifyColumnWidthResponse extends AbstractBasisResponse {

	private static final long serialVersionUID = 1L;
		
	/**
	 * Instantiates a new modify column width response.
	 *
	 * @param modifyColumnWidthRequest the modify column width request
	 */
	public ModifyColumnWidthResponse(ModifyColumnWidthRequest modifyColumnWidthRequest) {

		super(modifyColumnWidthRequest);
	}
