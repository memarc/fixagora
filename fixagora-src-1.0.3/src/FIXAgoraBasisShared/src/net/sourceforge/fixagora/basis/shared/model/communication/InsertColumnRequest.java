...
/**
 * The Class InsertColumnRequest.
 */
public class InsertColumnRequest extends AbstractBasisRequest {
	...
	/**
	 * Instantiates a new insert column request.
	 *
	 ...
	 */
	public InsertColumnRequest(long requestID, long sheetId, int column, int columnCount) {
	...
	public void handleAbstractFBasisRequest(BasisRequests basisRequests, Channel channel) {
		...
		basisRequests.onInsertColumnRequest(this, channel);
