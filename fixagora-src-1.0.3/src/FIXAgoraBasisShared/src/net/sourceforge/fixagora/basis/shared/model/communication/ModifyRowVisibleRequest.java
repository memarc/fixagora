 ...
 */
public class ModifyRowVisibleRequest extends AbstractBasisRequest {
	 ...
	 */
	public ModifyRowVisibleRequest(long requestID, long sheetId, int row, int rowCount,
			boolean visible) {
	...
	public void handleAbstractFBasisRequest(BasisRequests basisRequests, Channel channel) {
		...
		basisRequests.onModifyRowVisibleRequest(this, channel);
