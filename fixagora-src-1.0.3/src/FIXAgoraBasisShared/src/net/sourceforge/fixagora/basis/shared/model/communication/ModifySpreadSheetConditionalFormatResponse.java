...
/**
 * The Class ModifySpreadSheetConditionalFormatResponse.
 */
public class ModifySpreadSheetConditionalFormatResponse extends AbstractBasisResponse {

	private static final long serialVersionUID = 1L;
		
	/**
	 * Instantiates a new modify spread sheet conditional format response.
	 *
	 * @param modifySpreadSheetConditionalFormatRequest the modify spread sheet conditional format request
	 */
	public ModifySpreadSheetConditionalFormatResponse(ModifySpreadSheetConditionalFormatRequest modifySpreadSheetConditionalFormatRequest) {

		super(modifySpreadSheetConditionalFormatRequest);
	}
