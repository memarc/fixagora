 ...
 */
public class ModifySpreadSheetConditionalFormatRequest extends AbstractBasisRequest {
	...
	private SpreadSheetConditionalFormat spreadSheetConditionalFormat = null;
	 ...
	 */
	public ModifySpreadSheetConditionalFormatRequest(long requestID, long sheetId, int row, int rowCount, int column, int columnCount,
		...
		this.spreadSheetConditionalFormat = spreadSheetConditionalFormat;
	}
	...
	public void handleAbstractFBasisRequest(BasisRequests basisRequests, Channel channel) {
		...
		basisRequests.onModifySpreadSheetConditionalFormatRequest(this, channel);
