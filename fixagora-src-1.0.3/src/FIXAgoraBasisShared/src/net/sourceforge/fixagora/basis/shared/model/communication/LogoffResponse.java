...
/**
 * The Class LogoffResponse.
 */
public class LogoffResponse extends AbstractBasisResponse {

	private static final long serialVersionUID = 1L;
	
	/**
	 * Instantiates a new logoff response.
	 *
	 * @param logoffRequest the logoff request
	 */
	public LogoffResponse(LogoffRequest logoffRequest) {
