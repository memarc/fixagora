...
/**
 * The Class UniqueSecurityIDResponse.
 */
public class UniqueSecurityIDResponse extends AbstractBasisResponse {

	private static final long serialVersionUID = 1L;
	private boolean unique = false;
	
	/**
	 * Instantiates a new unique security id response.
	 *
	 * @param abstractRequest the abstract request
	 * @param unique the unique
	 */
	public UniqueSecurityIDResponse(UniqueSecurityIDRequest abstractRequest, boolean unique) {
