...
/**
 * The Class UniqueNameResponse.
 */
public class UniqueNameResponse extends AbstractBasisResponse {

	private static final long serialVersionUID = 1L;
	private boolean unique = false;
	
	/**
	 * Instantiates a new unique name response.
	 *
	 * @param abstractRequest the abstract request
	 * @param unique the unique
	 */
	public UniqueNameResponse(UniqueNameRequest abstractRequest, boolean unique) {
