...
/**
 * The Class DeleteColumnRequest.
 */
public class DeleteColumnRequest extends AbstractBasisRequest {
	...
	/**
	 * Instantiates a new delete column request.
	 *
	 ...
	 */
	public DeleteColumnRequest(long requestID, long sheetId, int column, int columnCount) {
	...
	public void handleAbstractFBasisRequest(BasisRequests basisRequests, Channel channel) {
		...
		basisRequests.onDeleteColumnRequest(this, channel);
