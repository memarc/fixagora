...
/**
 * The Class LogoffRequest.
 */
public class LogoffRequest extends AbstractBasisRequest {
	...
	/**
	 * Instantiates a new logoff request.
	 *
	 * @param fUser the f user
	 * @param requestID the request id
	 */
	public LogoffRequest(FUser fUser, long requestID) {
	...
	public void handleAbstractFBasisRequest(BasisRequests basisRequests, Channel channel) {
		...
		basisRequests.onLogoffRequest(this, channel);
