...
/**
 * The Class CloseSpreadSheetResponse.
 */
public class CloseSpreadSheetResponse extends AbstractBasisResponse {

	private static final long serialVersionUID = 1L;
	
	/**
	 * Instantiates a new close spread sheet response.
	 *
	 * @param closeSpreadSheetRequest the close spread sheet request
	 */
	public CloseSpreadSheetResponse(CloseSpreadSheetRequest closeSpreadSheetRequest) {
