...
/**
 * The Class DeleteColumnResponse.
 */
public class DeleteColumnResponse extends AbstractBasisResponse {

	private static final long serialVersionUID = 1L;
		
	/**
	 * Instantiates a new delete column response.
	 *
	 * @param deleteColumnRequest the delete column request
	 */
	public DeleteColumnResponse(DeleteColumnRequest deleteColumnRequest) {

		super(deleteColumnRequest);
	}
