...
/**
 * The Class CutSpreadSheetCellResponse.
 */
public class CutSpreadSheetCellResponse extends AbstractBasisResponse {

	private static final long serialVersionUID = 1L;
		
	/**
	 * Instantiates a new cut spread sheet cell response.
	 *
	 * @param cutSpreadSheetCellRequest the cut spread sheet cell request
	 */
	public CutSpreadSheetCellResponse(CutSpreadSheetCellRequest cutSpreadSheetCellRequest) {

		super(cutSpreadSheetCellRequest);
	}
