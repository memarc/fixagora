...
/**
 * The Class RootBusinessObjectRequest.
 */
public class RootBusinessObjectRequest extends AbstractBasisRequest {

	private static final long serialVersionUID = 1L;

	/**
	 * Instantiates a new root business object request.
	 *
	 * @param requestID the request id
	 */
	public RootBusinessObjectRequest(long requestID) {
	...
	public void handleAbstractFBasisRequest(BasisRequests basisRequests, Channel channel) {
		...
		basisRequests.onRootBusinessObjectRequest(this, channel);
	}
