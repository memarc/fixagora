...
/**
 * The Class OpenSpreadSheetResponse.
 */
public class OpenSpreadSheetResponse extends AbstractBasisResponse {

	private static final long serialVersionUID = 1L;
	
	
	/**
	 * Instantiates a new open spread sheet response.
	 *
	 * @param openSpreadSheetRequest the open spread sheet request
	 */
	public OpenSpreadSheetResponse(OpenSpreadSheetRequest openSpreadSheetRequest) {
