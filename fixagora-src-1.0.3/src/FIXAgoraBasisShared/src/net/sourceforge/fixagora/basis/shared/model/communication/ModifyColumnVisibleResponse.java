...
/**
 * The Class ModifyColumnVisibleResponse.
 */
public class ModifyColumnVisibleResponse extends AbstractBasisResponse {

	private static final long serialVersionUID = 1L;
		
	/**
	 * Instantiates a new modify column visible response.
	 *
	 * @param modifyColumnVisibleRequest the modify column visible request
	 */
	public ModifyColumnVisibleResponse(ModifyColumnVisibleRequest modifyColumnVisibleRequest) {

		super(modifyColumnVisibleRequest);
	}
