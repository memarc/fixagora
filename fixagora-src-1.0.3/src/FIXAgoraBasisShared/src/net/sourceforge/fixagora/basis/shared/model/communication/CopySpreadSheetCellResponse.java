...
/**
 * The Class CopySpreadSheetCellResponse.
 */
public class CopySpreadSheetCellResponse extends AbstractBasisResponse {

	private static final long serialVersionUID = 1L;
		
	/**
	 * Instantiates a new copy spread sheet cell response.
	 *
	 * @param copySpreadSheetCellRequest the copy spread sheet cell request
	 */
	public CopySpreadSheetCellResponse(CopySpreadSheetCellRequest copySpreadSheetCellRequest) {

		super(copySpreadSheetCellRequest);
	}
