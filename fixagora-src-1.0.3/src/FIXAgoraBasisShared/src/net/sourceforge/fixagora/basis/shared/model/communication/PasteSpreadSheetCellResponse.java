...
/**
 * The Class PasteSpreadSheetCellResponse.
 */
public class PasteSpreadSheetCellResponse extends AbstractBasisResponse {

	private static final long serialVersionUID = 1L;
		
	/**
	 * Instantiates a new paste spread sheet cell response.
	 *
	 * @param pasteSpreadSheetCellRequest the paste spread sheet cell request
	 */
	public PasteSpreadSheetCellResponse(PasteSpreadSheetCellRequest pasteSpreadSheetCellRequest) {

		super(pasteSpreadSheetCellRequest);
	}
