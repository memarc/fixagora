 ...
 */
public class InsertRowRequest extends AbstractBasisRequest {
	 ...
	 */
	public InsertRowRequest(long requestID, long sheetId, int row, int rowCount) {
	...
	public void handleAbstractFBasisRequest(BasisRequests basisRequests, Channel channel) {
		...
		basisRequests.onInsertRowRequest(this, channel);
