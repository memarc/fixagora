...
/**
 * The Class ModifyRowVisibleResponse.
 */
public class ModifyRowVisibleResponse extends AbstractBasisResponse {

	private static final long serialVersionUID = 1L;
		
	/**
	 * Instantiates a new modify row visible response.
	 *
	 * @param modifyRowVisibleRequest the modify row visible request
	 */
	public ModifyRowVisibleResponse(ModifyRowVisibleRequest modifyRowVisibleRequest) {

		super(modifyRowVisibleRequest);
	}
