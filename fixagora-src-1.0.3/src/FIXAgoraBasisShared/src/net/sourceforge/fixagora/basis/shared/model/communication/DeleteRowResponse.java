...
/**
 * The Class DeleteRowResponse.
 */
public class DeleteRowResponse extends AbstractBasisResponse {

	private static final long serialVersionUID = 1L;
		
	/**
	 * Instantiates a new delete row response.
	 *
	 * @param deleteRowRequest the delete row request
	 */
	public DeleteRowResponse(DeleteRowRequest deleteRowRequest) {

		super(deleteRowRequest);
	}
