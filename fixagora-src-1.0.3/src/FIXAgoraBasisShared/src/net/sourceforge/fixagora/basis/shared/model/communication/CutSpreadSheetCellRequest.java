...
/**
 * The Class CutSpreadSheetCellRequest.
 */
public class CutSpreadSheetCellRequest extends AbstractBasisRequest {
	...
	/**
	 * Instantiates a new cut spread sheet cell request.
	 *
	 ...
	 */
	public CutSpreadSheetCellRequest(long sourceSheetId, int sourceRow, int sourceRowCount, int sourceColumn,
	...
	public void handleAbstractFBasisRequest(BasisRequests basisRequests, Channel channel) {
		...
		basisRequests.onCutSpreadSheetCellRequest(this, channel);
