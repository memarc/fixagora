...
/**
 * The Class FillSpreadSheetCellResponse.
 */
public class FillSpreadSheetCellResponse extends AbstractBasisResponse {

	private static final long serialVersionUID = 1L;
		
	/**
	 * Instantiates a new fill spread sheet cell response.
	 *
	 * @param fillSpreadSheetCellRequest the fill spread sheet cell request
	 */
	public FillSpreadSheetCellResponse(FillSpreadSheetCellRequest fillSpreadSheetCellRequest) {

		super(fillSpreadSheetCellRequest);
	}
