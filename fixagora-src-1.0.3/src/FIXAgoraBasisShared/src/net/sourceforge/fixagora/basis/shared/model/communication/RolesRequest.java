...
/**
 * The Class RolesRequest.
 */
public class RolesRequest extends AbstractBasisRequest {

	private static final long serialVersionUID = 1L;
		
	/**
	 * Instantiates a new roles request.
	 *
	 * @param requestID the request id
	 */
	public RolesRequest(long requestID) {
	...
	public void handleAbstractFBasisRequest(BasisRequests basisRequests, Channel channel) {
		...
		basisRequests.onRolesRequest(this, channel);
