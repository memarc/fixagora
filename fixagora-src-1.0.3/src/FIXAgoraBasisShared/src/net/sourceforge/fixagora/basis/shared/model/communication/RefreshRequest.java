 ...
 */
public class RefreshRequest extends AbstractBasisRequest {
	 ...
	 */
	public RefreshRequest(String className, long objectId , long requestID) {
	...
	public void handleAbstractFBasisRequest(BasisRequests basisRequests, Channel channel) {
		...
		basisRequests.onRefreshRequest(this, channel);
