...
/**
 * The Class TradeCaptureEditorSourceDialog.
 */
public class TradeCaptureEditorSourceDialog extends JDialog {
	...
	/** The assigned trade capture source. */
	protected AssignedTradeCaptureSource assignedTradeCaptureSource;
	 ...
	 */
	public TradeCaptureEditorSourceDialog(List<AbstractBusinessObject> businessComponents) {

		setBounds(100, 100, 517, 157);
		setBackground(new Color(204, 216, 255));
		setIconImage(new ImageIcon(TradeCaptureEditorSourceDialog.class.getResource("/net/sourceforge/fixagora/basis/client/view/images/16x16/a-logo.png")).getImage());
		setModal(true);
		...
		setTitle("Add Trade Capture Source");
		...
		okButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				cancelled = false;
				assignedTradeCaptureSource = new AssignedTradeCaptureSource();
				assignedTradeCaptureSource.setBusinessComponent((AbstractBusinessComponent) ((ComboBoxEntry) businessComponentComboBox.getSelectedItem()).getEntry());
				setVisible(false);
			}
		});
	...
	/**
	 * Gets the assigned trade capture source.
	 *
	 * @return the assigned trade capture source
	 */
	public AssignedTradeCaptureSource getAssignedTradeCaptureSource() {
	
		return assignedTradeCaptureSource;
	}
