...
/**
 * The Class OpenBuySideBookRequest.
 */
public class OpenBuySideBookRequest extends AbstractBuySideRequest {
	...
	/**
	 * Instantiates a new open buy side book request.
	 *
	 * @param buySideBook the buy side book
	 * @param requestID the request id
	 */
	public OpenBuySideBookRequest(long buySideBook, long requestID) {
	...
	public void handleBuySideRequest(BuySideRequests buySideRequests, Channel channel) {
		...
		buySideRequests.onOpenBuySideBookRequest(this, channel);
