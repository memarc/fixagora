...
/**
 * The Class OpenQuoteDepthRequest.
 */
public class OpenQuoteDepthRequest extends AbstractBuySideRequest {
	...
	/**
	 * Instantiates a new open quote depth request.
	 *
	 * @param buySideQuotePage the buy side quote page
	 * @param security the security
	 * @param requestID the request id
	 */
	public OpenQuoteDepthRequest(long buySideQuotePage,long security, long requestID) {
	...
	public void handleBuySideRequest(BuySideRequests buySideRequests, Channel channel) {
		...
		buySideRequests.onOpenQuoteDepthRequest(this, channel);
