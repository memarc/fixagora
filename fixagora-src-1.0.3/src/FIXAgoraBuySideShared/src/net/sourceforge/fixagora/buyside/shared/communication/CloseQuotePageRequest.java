...
/**
 * The Class CloseQuotePageRequest.
 */
public class CloseQuotePageRequest extends AbstractBuySideRequest {
	...
	/**
	 * Instantiates a new close quote page request.
	 *
	 * @param buySideQuotePage the buy side quote page
	 * @param requestID the request id
	 */
	public CloseQuotePageRequest(long buySideQuotePage, long requestID) {
	...
	public void handleBuySideRequest(BuySideRequests buySideRequests, Channel channel) {
		...
		buySideRequests.onCloseQuotePageRequest(this, channel);
