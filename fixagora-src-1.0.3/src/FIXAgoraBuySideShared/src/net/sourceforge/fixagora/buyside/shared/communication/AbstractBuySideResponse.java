 ...
 */
public abstract class AbstractBuySideResponse extends AbstractResponse {
	...
	public void handleAbstractResponse(AbstractResponses abstractResponses) {
		...
		if(abstractResponses instanceof BuySideResponses)
		{
			BuySideResponses buySideResponses = (BuySideResponses)abstractResponses;
			handleBuySideResponse(buySideResponses);
		}
	 ...
	 *
	 * @param sellSideResponses the sell side responses
	 */
	public abstract void handleBuySideResponse(BuySideResponses sellSideResponses);	
