...
/**
 * The Class CloseTradeCaptureResponse.
 */
public class CloseTradeCaptureResponse extends AbstractTradeCaptureResponse {

	private static final long serialVersionUID = 1L;
	
	/**
	 * Instantiates a new close trade capture response.
	 *
	 * @param closeTradeCaptureRequest the close trade capture request
	 */
	public CloseTradeCaptureResponse(CloseTradeCaptureRequest closeTradeCaptureRequest) {
