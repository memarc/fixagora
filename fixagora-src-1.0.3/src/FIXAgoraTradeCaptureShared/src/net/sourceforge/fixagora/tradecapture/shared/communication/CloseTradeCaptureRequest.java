...
/**
 * The Class CloseTradeCaptureRequest.
 */
public class CloseTradeCaptureRequest extends AbstractTradeCaptureRequest {
	...
	/**
	 * Instantiates a new close trade capture request.
	 *
	 * @param tradeCapture the trade capture
	 * @param requestID the request id
	 */
	public CloseTradeCaptureRequest(long tradeCapture, long requestID) {
	...
	public void handleTradeCaptureRequest(TradeCaptureRequests tradeCaptureRequests, Channel channel) {
		...
		tradeCaptureRequests.onCloseTradeCaptureRequest(this, channel);
