...
/**
 * The Class AbstractTradeCaptureResponse.
 */
public abstract class AbstractTradeCaptureResponse extends AbstractResponse {

	private static final long serialVersionUID = 1L;

	/**
	 * Instantiates a new abstract trade capture response.
	 *
	 * @param abstractRequest the abstract request
	 */
	public AbstractTradeCaptureResponse(AbstractRequest abstractRequest) {
	...
	public void handleAbstractResponse(AbstractResponses abstractResponses) {
		...
		if(abstractResponses instanceof TradeCaptureResponses)
		{
			TradeCaptureResponses tradeCaptureResponses = (TradeCaptureResponses)abstractResponses;
			handleTradeCaptureResponse(tradeCaptureResponses);
		}
		
	}
	
	/**
	 * Handle trade capture response.
	 *
	 * @param tradeCaptureResponses the trade capture responses
	 */
	public abstract void handleTradeCaptureResponse(TradeCaptureResponses tradeCaptureResponses);	
