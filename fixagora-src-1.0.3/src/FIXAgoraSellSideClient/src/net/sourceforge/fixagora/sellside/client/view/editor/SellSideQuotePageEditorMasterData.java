...
/**
 * The Class SellSideQuotePageEditorMasterData.
 */
public class SellSideQuotePageEditorMasterData extends JScrollPane {
	...
	/**
	 * Instantiates a new sell side quote page editor master data.
	 *
	 * @param sellSideQuotePageEditor the sell side quote page editor
	 */
	public SellSideQuotePageEditorMasterData(SellSideQuotePageEditor sellSideQuotePageEditor) {
		...
		nameWarningLabel = sellSideQuotePageEditor.getNameWarningLabel();
		...
		gbc_sortSecuritiesLabel.gridy = 3;
		...
		gbc_localeOfissueTextField.gridy = 3;
		...
		gbc_descriptionWarningLabel.gridy = 4;
	...
	private void checkConsistency() {
		...
		if (nameTextField.getText().trim().length() == 0) {
			...
			nameWarningLabel.setIcon(sellSideQuotePageEditor.getBugIcon());
			...
			if (sellSideQuotePageEditor.getAbstractBusinessObject().getName() == null
					|| !sellSideQuotePageEditor.getAbstractBusinessObject().getName().equals(nameTextField.getText())) {

				sellSideQuotePageEditor.checkName(nameTextField.getText());
				dirty = true;
			}
		}
		...
		if (descriptionArea.getText().trim().length() == 0) {
			...
			descriptionWarningLabel.setIcon(sellSideQuotePageEditor.getWarningIcon());
		}
		else {
		...
		if (sellSideQuotePageEditor.getSellSideQuotePage().getDescription() != null
				&& !sellSideQuotePageEditor.getSellSideQuotePage().getDescription().equals(descriptionArea.getText())) {

			dirty = true;
		}
		
		if (sellSideQuotePageEditor.getSellSideQuotePage().getDescription() == null && descriptionArea.getText().trim().length()>0) {
			
			dirty = true;
		}
		
		if(sellSideQuotePageEditor.getSellSideQuotePage().getSortBy()==SortBy.MATURITY&&sortSecuritiesComboBox.getSelectedIndex()!=1)
			dirty=true;
		
		if(sellSideQuotePageEditor.getSellSideQuotePage().getSortBy()==SortBy.SYMBOL&&sortSecuritiesComboBox.getSelectedIndex()!=0)
			dirty=true;
		
		if(sellSideQuotePageEditor.getSellSideQuotePage().getDisplayStyle()!=styleComboBox.getSelectedIndex())
			dirty=true;
	...
	public void save() {
		...
		sellSideQuotePageEditor.getAbstractBusinessObject().setName(nameTextField.getText().trim());
		sellSideQuotePageEditor.getSellSideQuotePage().setDescription(descriptionArea.getText());
		sellSideQuotePageEditor.getSellSideQuotePage().setDisplayStyle(styleComboBox.getSelectedIndex());
		if(sortSecuritiesComboBox.getSelectedIndex()==1)
			sellSideQuotePageEditor.getSellSideQuotePage().setSortBy(SortBy.MATURITY);
		else
			sellSideQuotePageEditor.getSellSideQuotePage().setSortBy(SortBy.SYMBOL);
	}
	...
	public void updateContent() {
		...
		nameTextField.setText(sellSideQuotePageEditor.getAbstractBusinessObject().getName());
		descriptionArea.setText(sellSideQuotePageEditor.getSellSideQuotePage().getDescription());
		if(sellSideQuotePageEditor.getSellSideQuotePage().getSortBy()==SortBy.MATURITY)
			sortSecuritiesComboBox.setSelectedIndex(1);
		else
			sortSecuritiesComboBox.setSelectedIndex(0);
			
		styleComboBox.setSelectedIndex(sellSideQuotePageEditor.getSellSideQuotePage().getDisplayStyle());
		
		if (sellSideQuotePageEditor.getAbstractBusinessObject().getId() != 0) {

			StringBuffer textBuffer = new StringBuffer();
			textBuffer.append(DateFormat.getTimeInstance().format(sellSideQuotePageEditor.getAbstractBusinessObject().getModificationDate()));
			textBuffer.append(" ");
			textBuffer
					.append(DateFormat.getDateInstance(DateFormat.SHORT).format(sellSideQuotePageEditor.getAbstractBusinessObject().getModificationDate()));

			if (sellSideQuotePageEditor.getAbstractBusinessObject().getModificationUser() != null) {

				textBuffer.append(" by ");
				textBuffer.append(sellSideQuotePageEditor.getAbstractBusinessObject().getModificationUser());
			}
